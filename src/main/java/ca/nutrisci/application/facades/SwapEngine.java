...
public class SwapEngine implements ISwapFacade {
    ...
    public SwapDTO applySwap(UUID profileId, SwapDTO swapDTO) {
        ...
        // Save to history
        SwapHistory savedHistory = swapHistoryRepo.save(swapHistory);
    ...
    public List<SwapDTO> getSwapHistoryByGoal(UUID profileId, String goalType) {
        ...
        List<SwapHistory> history = swapHistoryRepo.findByProfileIdAndGoalType(profileId, goalType.trim());
    ...
    public void deleteSwapHistory(UUID swapHistoryId) {
        ...
        SwapHistory history = swapHistoryRepo.findById(swapHistoryId);
        if (history == null) {
