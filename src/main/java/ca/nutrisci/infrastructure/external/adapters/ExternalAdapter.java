...
public class ExternalAdapter implements INutritionGateway {
    ...
    private NutrientInfo createNutrientInfo(Map<String, Double> nutrients) {
        ...
        double sugar = nutrients.getOrDefault("269", 0.0);       // Sugar (g)
        ...
        return new NutrientInfo(calories, protein, carbs, fat, fiber, sugar);
    }
    ...
    private void loadDefaultData() {
        ...
        // Proteins
        defaultNutrition.put("chicken breast", new NutrientInfo(165, 31.0, 0.0, 3.6, 0.0, 0.0));
        defaultNutrition.put("chicken", new NutrientInfo(165, 31.0, 0.0, 3.6, 0.0, 0.0));
        defaultNutrition.put("beef", new NutrientInfo(250, 26.0, 0.0, 15.0, 0.0, 0.0));
        defaultNutrition.put("pork", new NutrientInfo(242, 27.0, 0.0, 14.0, 0.0, 0.0));
        defaultNutrition.put("fish", new NutrientInfo(206, 22.0, 0.0, 12.0, 0.0, 0.0));
        defaultNutrition.put("salmon", new NutrientInfo(208, 20.0, 0.0, 13.0, 0.0, 0.0));
        defaultNutrition.put("tuna", new NutrientInfo(184, 30.0, 0.0, 6.0, 0.0, 0.0));
        defaultNutrition.put("egg", new NutrientInfo(155, 13.0, 1.1, 11.0, 0.0, 0.0));
        defaultNutrition.put("eggs", new NutrientInfo(155, 13.0, 1.1, 11.0, 0.0, 0.0));
        defaultNutrition.put("turkey", new NutrientInfo(135, 30.0, 0.0, 1.0, 0.0, 0.0));
        
        // Dairy
        defaultNutrition.put("milk", new NutrientInfo(42, 3.4, 5.0, 1.0, 0.0, 4.8));
        defaultNutrition.put("cheese", new NutrientInfo(113, 25.0, 1.0, 9.0, 0.0, 0.5));
        defaultNutrition.put("yogurt", new NutrientInfo(59, 10.0, 3.6, 0.4, 0.0, 3.2));
        defaultNutrition.put("butter", new NutrientInfo(717, 0.9, 0.1, 81.0, 0.0, 0.1));
        defaultNutrition.put("cream", new NutrientInfo(195, 2.8, 3.4, 20.0, 0.0, 3.1));
        
        // Grains and starches
        defaultNutrition.put("bread", new NutrientInfo(265, 9.0, 49.0, 3.2, 2.7, 5.0));
        defaultNutrition.put("rice", new NutrientInfo(130, 2.7, 28.0, 0.3, 0.4, 0.1));
        defaultNutrition.put("pasta", new NutrientInfo(131, 5.0, 25.0, 1.1, 1.8, 0.8));
        defaultNutrition.put("oats", new NutrientInfo(389, 16.9, 66.3, 6.9, 10.6, 0.0));
        defaultNutrition.put("cereal", new NutrientInfo(357, 7.5, 84.0, 2.8, 7.0, 5.0));
        defaultNutrition.put("quinoa", new NutrientInfo(368, 14.1, 64.2, 6.1, 7.0, 0.0));
        defaultNutrition.put("wheat", new NutrientInfo(327, 12.6, 71.2, 1.5, 12.2, 0.0));
        defaultNutrition.put("barley", new NutrientInfo(354, 12.5, 73.5, 2.3, 17.3, 0.0));
        
        // Vegetables
        defaultNutrition.put("tomato", new NutrientInfo(18, 0.9, 3.9, 0.2, 1.2, 2.6));
        defaultNutrition.put("tomatoes", new NutrientInfo(18, 0.9, 3.9, 0.2, 1.2, 2.6));
        defaultNutrition.put("lettuce", new NutrientInfo(15, 1.4, 2.9, 0.2, 1.3, 0.8));
        defaultNutrition.put("spinach", new NutrientInfo(23, 2.9, 3.6, 0.4, 2.2, 0.4));
        defaultNutrition.put("broccoli", new NutrientInfo(34, 2.8, 7.0, 0.4, 2.6, 1.7));
        defaultNutrition.put("carrots", new NutrientInfo(41, 0.9, 10.0, 0.2, 2.8, 4.7));
        defaultNutrition.put("onion", new NutrientInfo(40, 1.1, 9.3, 0.1, 1.7, 4.2));
        defaultNutrition.put("bell pepper", new NutrientInfo(31, 1.0, 7.0, 0.3, 2.5, 4.2));
        defaultNutrition.put("cucumber", new NutrientInfo(16, 0.7, 4.0, 0.1, 0.5, 1.7));
        defaultNutrition.put("potato", new NutrientInfo(77, 2.0, 17.0, 0.1, 2.2, 0.8));
        defaultNutrition.put("corn", new NutrientInfo(86, 3.3, 19.0, 1.4, 2.7, 3.2));
        
        // Fruits
        defaultNutrition.put("apple", new NutrientInfo(52, 0.3, 14.0, 0.2, 2.4, 10.4));
        defaultNutrition.put("apples", new NutrientInfo(52, 0.3, 14.0, 0.2, 2.4, 10.4));
        defaultNutrition.put("banana", new NutrientInfo(89, 1.1, 23.0, 0.3, 2.6, 12.2));
        defaultNutrition.put("bananas", new NutrientInfo(89, 1.1, 23.0, 0.3, 2.6, 12.2));
        defaultNutrition.put("orange", new NutrientInfo(47, 0.9, 12.0, 0.1, 2.4, 9.4));
        defaultNutrition.put("berries", new NutrientInfo(57, 0.7, 14.0, 0.3, 2.4, 4.9));
        defaultNutrition.put("strawberries", new NutrientInfo(32, 0.7, 7.7, 0.3, 2.0, 4.9));
        defaultNutrition.put("grapes", new NutrientInfo(62, 0.6, 16.0, 0.2, 0.9, 15.0));
        
        // Nuts and seeds
        defaultNutrition.put("almonds", new NutrientInfo(579, 21.0, 22.0, 50.0, 12.0, 4.4));
        defaultNutrition.put("walnuts", new NutrientInfo(654, 15.0, 14.0, 65.0, 6.7, 2.6));
        defaultNutrition.put("peanuts", new NutrientInfo(567, 26.0, 16.0, 49.0, 8.5, 4.7));
        defaultNutrition.put("sunflower seeds", new NutrientInfo(584, 20.8, 20.0, 51.5, 8.6, 2.6));
        
        // Oils and fats
        defaultNutrition.put("olive oil", new NutrientInfo(884, 0.0, 0.0, 100.0, 0.0, 0.0));
        defaultNutrition.put("oil", new NutrientInfo(884, 0.0, 0.0, 100.0, 0.0, 0.0));
        defaultNutrition.put("vegetable oil", new NutrientInfo(884, 0.0, 0.0, 100.0, 0.0, 0.0));
        
        // Legumes
        defaultNutrition.put("beans", new NutrientInfo(347, 22.0, 63.0, 1.2, 15.0, 2.1));
        defaultNutrition.put("lentils", new NutrientInfo(353, 25.0, 60.0, 1.1, 10.7, 2.0));
        defaultNutrition.put("chickpeas", new NutrientInfo(378, 20.0, 63.0, 6.0, 12.0, 11.0));
        defaultNutrition.put("black beans", new NutrientInfo(341, 21.6, 62.4, 1.4, 15.0, 2.1));
    ...
    public NutrientInfo lookupIngredient(String ingredient) {
        ...
        if (ingredient == null || ingredient.trim().isEmpty()) {
            return new NutrientInfo(0, 0, 0, 0, 0, 0);
        }
        ...
        return new NutrientInfo(50, 2.0, 5.0, 1.0, 0.5, 0.0);
    }
